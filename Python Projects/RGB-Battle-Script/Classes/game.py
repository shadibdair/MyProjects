...
class Person:
    ...
    def choose_action(self):
        i = 1
        print("\n" + "    " + bcolor.BOLD + str(self.name) + bcolor.ENDC)
    ...
    def get_enemy_stats(self):
        ...
        hp_string = str(int(self.hp)) + "/" + str(int(self.maxhp))
        current_hp = ""
        ...
        print(bcolor.BOLD + str(self.name) + "        " +
    ...
    def get_stats(self):
        hp_bar = ""
        bar_ticks = (self.hp / self.maxhp) * 100.0 / 4
        ...
        mp_string = str(int(self.mp)) + "/" + str(int(self.maxmp))
        current_mp = ""
        ...
        print(bcolor.BOLD + str(self.name) + "         " +
              current_hp +" |" + bcolor.OKGREEN + hp_bar + bcolor.ENDC + "|    " +
