...
while running:
        ...
        if index == 0:
            ...
            if spell.type == "white":
                ...
                print(bcolor.OKBLUE + "\n" + spell.name + " deals " + str(magic_dmg) + " points of damage to " +
                      enemies[enemy].name.replace(" ", "") + bcolor.ENDC)
    ...
    for enemy in enemies:
        ...
        if enemy_choice == 0:
            ...
            print(enemy.name.replace(" ", "") + " attacks" + players[target].name.replace(" ", "") + " for " + str(
                enemy_dmg))
            ...
            if spell.type == "white":
                ...
                print(bcolor.OKBLUE + spell.name + " heals " + enemy.name + "for " + str(
                    magic_dmg) + " HP." + bcolor.ENDC)
            elif spell.type == "black":
                target = random.randrange(0, 3)
                ...
                if players[target].get_hp() == 0:
                    ...
                    del players[player]
            # print("Enemy choose " + str(spell) + " damage is " + str(magic_dmg))
